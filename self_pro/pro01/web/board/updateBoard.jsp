...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="">HOME</a> &gt; <a href="">게시글 목록</a> &gt; <a href="">게시글 목록</a> &gt; <span>게시글 수정</span></p>
        </div>
                        ...
                        <table class="tb1">
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="bno" id="bno" class="indata" value="<%=bno%>" readonly required></td>
                                </tr>
                                <tr>
                                    <th class="item3">제목</th>
                                    <td><input type="text" name="title" id="title" class="indata" value="<%=bd.getTitle()%>" autofocus required></td>
                                </tr>
                                <tr>
                                    <th colspan="2" class="item4">내용</th>
                                </tr>
                                <tr>
                                    <td colspan="2"><textarea name="content" id="content" class="" cols="80" rows="15" maxlength="100" required><%=bd.getContent()%></textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
