...
<head>
    ...
    <style>
        ...
        .tb1 { width:600px; margin:0 auto; font-size: 18px;}
        .tb1 th { width: 200px; line-height: 24px;
            border-bottom: 1px solid #333; border-top: 1px solid #333; box-sizing: border-box; text-align: center;}
        .tb1 td { width: 400px; line-height: 24px;
            border-bottom: 1px solid #333; border-top: 1px solid #333; box-sizing: border-box; text-align: center;}
...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/faq/addFaq.jsp">온라인 상담</a></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">온라인 상담</h2>
                <form action="onlinepro.jsp" id="login_frm" class="frm">
                    <table class="tb1">
                        <tbody>
                        <tr>
                            <th><label for="id">아이디</label></th>
                            <td><input type="text" name="id" id="id" value="<%=sid%>" readonly></td>
                        </tr>
                        <tr>
                            <th><label for="name">이름</label></th>
                            <td><input type="text" name="name" id="name" value="<%=sname %>" readonly></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="tel" name="tel" id="tel" placeholder="연락처 기입" required></td>
                        </tr>
                        <tr>
                            <th><label for="question">상담 제목</label></th>
                            <td><input type="text" name="question" id="question" class="indata" placeholder="제목 입력" autofocus required></td>
                        </tr>
                        <tr>
                            <th><label for="answer">상담 내용</label></th>
