...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <section class="page" id="page1">
            <div class="page_wrap">
                <form action="${path}/free/imageUpload.do" id="login_frm" class="frm" method="post" enctype="multipart/form-data">
                    <table class="tb1">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><textarea name="content" id="content" class="textarea" cols="50" rows="15" maxlength="1800"
