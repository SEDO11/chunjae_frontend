...
public interface DBConnect {
    ...
    final static String CUSTOM_SELECT_ALL = "select * from custom order by no desc";
    ...
    final static String CUSTOM_UPDATE = "update custom set title=?, content=? where no=?";
    final static String CUSTOM_DELETE = "delete from custom where no=?";
